...
The new contract check, full source-contract suite, TypeScript check and production build must pass before this source slice is committed. Browser review and PHP/PostgreSQL route verification remain open; test card-specific/default/no-back cards, foreign-private backs, face-up transitions, moved/removed cards and non-member or removed-member requests against the deployed release.
