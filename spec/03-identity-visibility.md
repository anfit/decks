...
Card identity, location and face state are separate. Public face-up cards expose an authorized front projection. Public face-down and private cards expose only the minimum interaction handle, back asset and spatial/container information permitted to the viewer. A hand owner sees its identities; other participants receive counts unless an explicit reveal occurs. The host does not see hands by default.
