...
Host transfer clears explicit capability overrides for both participants as their roles change. The incoming host receives the host role defaults, including a working participant/session administration recovery path; the outgoing host receives player defaults instead of retaining stale host-era grants or denials.
